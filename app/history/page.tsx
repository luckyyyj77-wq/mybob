          ...
          <div style={{
            ...
            {qlStep === 'input' && (
              <>
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '0 24px 8px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                      <input
                        type="date" value={qlDate} max={todayKST()}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        color: 'black', outline: 'none', boxSizing: 'border-box', backgroundColor: 'white',
                      }}
                    />
                ...
                {/* 저장 버튼 — 고정 하단 */}
                <div style={{ padding: '12px 24px 32px', borderTop: '1px solid #f3f4f6', backgroundColor: 'white' }}>
                  <button
