        ...
        <AnimatePresence mode="wait">
          {!imageSrc ? (
            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ width: '56px', height: '56px', border: '1px solid rgba(255,255,255,0.5)', borderRadius: '50%' }} />
                </div>
              </div>
            ...
            >
              ...
              <AnimatePresence>
                {loadingAnalysis && (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px', gap: '12px', border: '1px solid #e5e7eb' }}>
                    <FaSpinner style={{ fontSize: '20px', animation: 'spin 1s linear infinite', color: '#9ca3af' }} />
                ...
                {analysis && !loadingAnalysis && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    style={{ border: '1px solid #e5e7eb', padding: '20px' }}
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                      <h3 style={{ fontSize: '20px', fontWeight: 400, color: 'black' }}>{analysis.name}</h3>
                      <div style={{ textAlign: 'right' }}>
                        <p style={{ fontSize: '20px', fontWeight: 400, color: '#6B21A8', lineHeight: 1 }}>{analysis.calories}</p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px' }}>
                      {[
                        ...
                        <div key={n.label} style={{ padding: '12px', border: '1px solid #e5e7eb', textAlign: 'center' }}>
                          <p style={{ fontSize: '10px', color: '#9ca3af', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '4px' }}>{n.label}</p>
                          <p style={{ fontSize: '16px', fontWeight: 400, color: 'black' }}>{n.value}g</p>
                        </div>
                      ))}
                    </div>
