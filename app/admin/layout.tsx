...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (checking) return (
    <div style={{ minHeight: '100svh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0f0f0f' }}>
  ...
  return (
    <div style={{ minHeight: '100svh', backgroundColor: '#f8f9fa', display: 'flex' }}>
